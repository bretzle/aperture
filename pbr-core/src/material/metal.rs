...
impl Metal {
    pub fn create(mp: &TextureParams<'_>) -> Arc<dyn Material> {
        let copper_eta = Spectrum::from_sampled(&COPPER_WAVELENGTHS[..], &COPPER_N[..], COPPER_SAMPLES);
        let eta = mp.get_spectrum_texture("eta", &copper_eta);
        let copper_k = Spectrum::from_sampled(&COPPER_WAVELENGTHS[..], &COPPER_K[..], COPPER_SAMPLES);
...
const COPPER_N: [f32; COPPER_SAMPLES] = [
    ...
    1.300313, 1.29, 1.281563, 1.27, 1.249062, 1.225, 1.2, 1.18, 1.174375, 1.175, 1.1775, 1.18, 1.178125,
    1.175, 1.172812, 1.17, 1.165312, 1.16, 1.155312, 1.15, 1.142812, 1.135, 1.131562, 1.12, 1.092437,
    1.04, 0.950375, 0.826, 0.645875, 0.468, 0.35125, 0.272, 0.230813, 0.214, 0.20925, 0.213, 0.21625,
