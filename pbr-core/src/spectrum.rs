...
pub mod Colors {
    ...
    pub const BLACK: Rgb = Rgb::rgb(0.0, 0.0, 0.0);
    pub const RED: Rgb = Rgb::rgb(1.0, 0.0, 0.0);
    pub const GREEN: Rgb = Rgb::rgb(0.0, 1.0, 0.0);
    pub const BLUE: Rgb = Rgb::rgb(0.0, 0.0, 1.0);
    pub const WHITE: Rgb = Rgb::rgb(1.0, 1.0, 1.0);
}
